...
<section class="section"
    style="background-image: url('ruta/a/tu/imagen-de-fondo.jpg'); background-size: cover; min-height: 100vh; display: flex; align-items: center;">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cantidad" class="form-control"
                                            value="{{ $materia->cantidad }}" min="{{ $materia->cantidad }}">
                                    </div>
                                </div>
