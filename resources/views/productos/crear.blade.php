            ...
            <div class="col-md-8">
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-body p-4 bg-white">
                        ...
                        <form action="{{ route('productos.store') }}" method="POST" class="my-4">
                            @csrf
                            ...
                            <div class="form-group floating-label">
                                ...
                                <input type="text" name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" required value="{{ old('descripcion') }}">
